  ...
  return (
        <article className='max-w-[1040px] mx-auto mb-[100px]' id='about'>
            ...
            <div className='font-poppin leading-[150%] p-2'>
                    ...
                    <p data-aos="fade-in" data-aos-delay="1500">PROOF OF INU IS THE BLOCKCHAIN BASED ON THE "PROOF OF STAKE", PROOF OF Authority", "PROOF OF History" CONSENSUS MECHANISMS.</p>
            </div>
        </article>
  )
}
