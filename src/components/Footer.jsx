        ...
        <footer className='border-t py-4 text-center md:text-left'>
            <div className="container mx-auto flex flex-col md:flex-row items-center md:items-start  gap-4">
                <div className='flex items-center'>
                    ...
                    <span className='text-lg'>Turtle Bot</span>
                </div>
                ...
                <div className='mb-4 md:mb-0'>
                    ...
                    <ul className='text-sm font-poppin'>
                        <a target="_blank" className='my-2'><li>Twitter <i className="fa-brands fa-twitter"></i></li></a>
                        <a target="_blank" className='my-2'><li>Telegram <i className="fa-brands fa-telegram"></i></li></a>
                        <a target="_blank" className='my-2'><li>Medium <i class="fa-brands fa-medium"></i></li></a>
                    </ul>
                </div>
            </div>
            <p className='text-center text-xs'>© The Turtle Bot. All rights reserved.</p>
        </footer>
    )
}
